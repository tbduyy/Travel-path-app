...
export const metadata: Metadata = {
  ...
  description:
    "Khám phá những kinh nghiệm du lịch, câu chuyện hành trình và mẹo vặt hữu ích từ cộng đồng Travel Path.",
  alternates: { canonical: "https://www.travelpath.io.vn/blog" },
  openGraph: {
    title: "Cẩm Nang Du Lịch",
    description:
      "Khám phá những kinh nghiệm du lịch, câu chuyện hành trình và mẹo vặt hữu ích từ cộng đồng Travel Path.",
    url: "https://www.travelpath.io.vn/blog",
    ...
    <main className="min-h-screen bg-[#F0F9F9] relative font-sans text-[#1B4D3E]">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-12">
        <div className="text-center mb-16 space-y-4">
          <span className="text-[#2E968C] font-bold tracking-widest uppercase text-sm">
            Travel Path Blog
          </span>
          <h1 className="text-4xl md:text-5xl font-yeseva font-black uppercase text-[#1B4D3E]">
            Cẩm Nang Du Lịch
          </h1>
          <p className="text-gray-500 max-w-2xl mx-auto">
            Nơi chia sẻ những kinh nghiệm, câu chuyện và những hành trình đầy
            cảm hứng.
          </p>
        </div>
                ...
                <div className="relative w-full h-64 overflow-hidden bg-gray-100">
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    {post.tags.map((tag) => (
                      <span
                        key={tag}
                        className="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-[#1B4D3E] shadow-sm"
                      >
                        {tag}
                      </span>
                    ))}
