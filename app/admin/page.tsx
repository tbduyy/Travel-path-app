    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map((card) => (
          ...
          >
            <div
              className={`w-16 h-16 rounded-2xl ${card.color} bg-opacity-10 flex items-center justify-center group-hover:scale-110 transition-transform`}
            >
              <card.icon
            ...
            <div>
              ...
              <p className="text-4xl font-black text-[#1B4D3E] mt-1">
                {card.value}
              </p>
            </div>
          </Link>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          Hệ thống quản trị Travel Path. Sử dụng menu bên trái để quản lý nội
          dung.
        </p>
      </div>
    </div>
