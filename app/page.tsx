  ...
  return (
    <PageTransition>
      <main className="min-h-screen relative flex flex-col items-center bg-[#BBD9D9]">
        ...
        {/* Hero Content */}
        <div className="relative z-10 w-full items-center max-w-7xl mx-auto px-4 md:px-8 flex flex-col justify-center min-h-[70vh] md:min-h-screen pb-4 md:pb-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between w-full h-full gap-4 md:gap-8">
            ...
            {/* Right: Slide Widget */}
            <div className="flex-1 hidden md:flex justify-end items-center w-full md:pr-24 pb-12">
              <CitySlideWidget />
            </div>
          </div>
