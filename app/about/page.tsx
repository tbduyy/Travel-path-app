            ...
            <div className="w-full max-w-4xl mx-auto px-6 py-12 md:py-20 relative z-10">
                ...
                <div className="bg-white/80 backdrop-blur-md rounded-[3rem] p-8 md:p-16 shadow-xl border border-white/50 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="text-center mb-16">
                        <span className="text-[#2E968C] font-bold tracking-widest uppercase text-sm mb-2 block">Our Story</span>
                        <h1 className="text-4xl md:text-5xl font-black mb-6 uppercase text-[#1B4D3E]">Về Travel Path</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-4 group">
                            <div className="w-16 h-16 bg-[#E8F1F0] rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#1B4D3E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="m9 12 2 2 4-4" /></svg>
                            </div>
                            <h2 className="text-2xl font-extrabold uppercase text-[#1B4D3E]">Tầm nhìn</h2>
                        ...
                        <div className="space-y-4 group">
                            <div className="w-16 h-16 bg-[#FFF4E6] rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#F4A261" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>
                            </div>
                            <h2 className="text-2xl font-extrabold uppercase text-[#1B4D3E]">Sứ mệnh</h2>
                    ...
                    <div className="mt-16 bg-[#1B4D3E] text-white rounded-3xl p-8 md:p-10 text-center relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-full opacity-10">
                            <Image src="/assets/plan-trip/rectangle-7.png" alt="Pattern" fill className="object-cover" />
                        </div>
                        <div className="relative z-10">
                            <h3 className="text-2xl md:text-3xl font-black mb-4 italic">“Thực hiện hóa chuyến đi mơ ước của bạn”</h3>
                            <p className="text-lg md:text-xl font-medium text-white/90 max-w-2xl mx-auto leading-relaxed">
                                Travel Path cam kết giúp mỗi chuyến đi không chỉ là một hành trình, mà còn là trải nghiệm được thiết kế riêng, đúng với nhu cầu và cảm xúc của bạn.
                            </p>
                        </div>
                    </div>
