...
const cities = [
  {
    name: "Nha Trang",
    description:
      "Mê hoặc du khách với biển xanh trong, nắng vàng và nhịp sống biển.",
    image:
      "https://cwlovgpnraogycqfbwvx.supabase.co/storage/v1/object/public/home-page/cities/nhatrang.webp",
  },
  {
    name: "Đà Lạt",
    description:
      "Ghi dấu trong lòng du khách bởi khí trời mát dịu, cảnh sắc và vẻ yên bình.",
    image:
      "https://cwlovgpnraogycqfbwvx.supabase.co/storage/v1/object/public/home-page/cities/dalat.jpg",
  },
  {
    name: "Hội An",
    description:
      "Gây thương nhớ bởi vẻ cổ kính, đèn lồng và nhịp sống chậm đầy hoài niệm.",
    image:
      "https://cwlovgpnraogycqfbwvx.supabase.co/storage/v1/object/public/home-page/cities/hoian.jpg",
  },
  {
    name: "TP. Hồ Chí Minh",
    description:
      "Sôi động với nhịp sống nhanh, năng lượng và sự giao thoa hiện đại – truyền thống.",
    image:
      "https://cwlovgpnraogycqfbwvx.supabase.co/storage/v1/object/public/home-page/cities/saigon.jpg",
  },
  {
    name: "Hà Nội",
    description:
      "Trầm lắng và sâu lắng, nổi bật với nét cổ kính, và văn hóa nghìn năm.",
    image:
      "https://cwlovgpnraogycqfbwvx.supabase.co/storage/v1/object/public/home-page/cities/hanoi.jpg",
  },
];
      ...
      <div className="relative w-full h-full">
        {cities.map((city, index) => {
          ...
          if (isCurrent) {
            ...
            transformClass =
              "scale-90 opacity-80 translate-x-0 -translate-y-4 z-30";
            zIndex = 30;
          } else if (isNextNext) {
            transformClass =
              "scale-80 opacity-60 translate-x-0 -translate-y-8 z-20";
            zIndex = 20;
          } else if (isNextNextNext) {
            transformClass =
              "scale-70 opacity-40 translate-x-0 -translate-y-12 z-10";
            zIndex = 10;
          }
