...
interface TripMetaBarProps {
    ...
    placeCount: number;
    budget: string;
    className?: string; // Allow custom styling wrapper if needed, but defaults are good
}

export default function TripMetaBar({ destination, duration, placeCount, budget, className = "" }: TripMetaBarProps) {
    return (
        <div className={`flex flex-wrap items-center gap-6 text-[#1B4D3E] text-sm font-bold ml-1 ${className}`}>
            ...
            <div className="flex items-center gap-2">
                ...
                <span>{placeCount} Điểm yêu thích đã chọn</span>
            </div>
            <div className="flex items-center gap-2">
